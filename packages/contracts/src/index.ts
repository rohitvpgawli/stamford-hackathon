...
export interface HermesOutput { action:'ASK_FOLLOWUP'|'RECOMMEND'|'EXPLAIN'|'REDIRECT'|'APP_UPSELL'|'NO_RESULT'; reply_text:string; opportunity_id:string|null; reason_codes_used:string[]; profile_updates:Array<{key:string;value:unknown;confidence:number}>; needs_confirmation:boolean; }
